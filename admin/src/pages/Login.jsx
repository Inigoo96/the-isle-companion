...
export default function Login() {
  function handleDiscordLogin() {
    // Full-page redirect to the backend, which starts the Discord OAuth2 flow
    // and redirects back to /auth/callback?token=… once authorized.
    ...
    <div className={styles.page}>
      <div className={styles.card}>
        ...
        <p className={styles.footer}>
          Sign in with the Discord account that owns or administrates your community server.
        </p>
      </div>
    </div>
  );
